...
const career = new Vue({
  ...
  data:{
    list: [{ 
      ...
      txt : '마크업과 스크립트 개발을 담당했으며, 직접 작업환경을 구성해 적용하며 좀 더 웹팩을 익숙하게 다룰 수 있게 되었습니다.'
        + '\n또한 nodeJS와 socket.io를 이용한 실시간 서비스와 EChart를 접목한 실시간 차트를 개발했습니다.',
      proj : [{
        tit : '비트파이 - 비트코인 트레이딩 플랫폼 거래소',
        use : ['html','css','javascript'],
        desc :
          [ 
            'nodeJS와 socket.io를 이용한 실시간 거래 및 EChart와 접목해 실시간 차트를 구현하였습니다.'
          ]
        },
        {
          tit : '사내 어드민 시스템',
      ...
      txt : 'FT개발팀:검색개발셀에서 IE8에 대응하는 마크업과 스크립트 개발을 함께 했으며, javascript의 기본기를 제대로 다질 수 있었습니다.'
            + '\njQuery + ES6 문법의 일부를 활용하여 개발을 진행하였습니다.'
